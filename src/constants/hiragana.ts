...
import { defaultColumnGrouping, diacriticsColumnGrouping, digraphsColumnGrouping, digraphsDiacriticsColumnGrouping } from './characters';
...
export const hiraganaCharacterTables: CharacterTable[] = [
    ...
    new CharacterTable('Digraphs', '(yōon)', 'hiraganadigraphs', hiraganaYoon, digraphsColumnGrouping, hiraganaDigraphsRowGrouping),
    new CharacterTable(
