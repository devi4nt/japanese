export class DragDrop {
    ...
    constructor(wrapperElement: HTMLElement) {
        ...
        this.dragSourceElement = wrapperElement.querySelector(
            "[data-drag-source]"
        );
        const dragNodes = wrapperElement.querySelectorAll(
            "[data-drag-element]"
        ...
        Array.from(dragNodes).forEach(dragElement => {
            ...
            dropElement.parent.addEventListener("drop", (e: MouseEvent) =>
                this.drop(e, dropElement)
            );
            dropElement.parent.addEventListener("dragover", (e: MouseEvent) =>
                e.preventDefault()
            );
            dropElement.element.addEventListener("dragstart", (e: MouseEvent) =>
                this.drag(e)
            );
    ...
    start(): void {
        ...
        this.shuffle<IDropElement>(this.dropElements).forEach(dropElement =>
            this.dragSetup(dropElement)
        );
    ...
    dragReset(dropElement: IDropElement): void {
        ...
        if (dropElement.placeHolder) {
            ...
            dropElement.placeHolder = undefined;
        }
    ...
    tick(): void {
        ...
        if (remaining) {
            ...
            this.timerElement.innerHTML = String(
